...
Crete is a Python CLI tool that I built as part of my Masters dissertation.
While it was partially just a part of my procrastination, it actually turned out to be quite useful.
It fully integrates the OpenAI gym, your agents, training and evaluation together in a simple and extensible interface.
